...
**Wax** escribe el temario de la segunda era, y es lo más largo del juego: **90 lecciones,
576.000 caracteres**, una por reto — entre 5.700 y 7.400 cada una, sin excepción. No son notas
...
entre leer y practicar, y es una decisión y no una prisa. En total, **306 lecciones y
1.197.000 caracteres**, una por reto y sin excepción.
...
construcción. Un test recorre los 306 retos y comprueba que **cada palabra que puede decir
...
recorre los 276 retos con pistas y comprueba que la última no contenga ni una línea de su
...
npm run dev
npm test        # motor, almacenes, Armonía, Marasi y las soluciones de los 306 retos
npm run test:e2e
```
