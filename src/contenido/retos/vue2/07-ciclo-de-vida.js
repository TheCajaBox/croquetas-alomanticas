...
export default {
  ...
  apunte: codigo(
    ...
    "",
    "- **`created`**: ya existen los datos, pero todavía no hay nada en pantalla.",
    "- **`mounted`**: ya está pintado. Aquí es donde se toca el DOM, se arrancan",
    "  temporizadores o se piden datos que necesitan la vista puesta.",
    ...
    "después de que el componente haya desaparecido**, apuntando a datos que ya no",
    "se pintan. Es una fuga de memoria, y de las que no se ven hasta que la",
    "aplicación lleva un rato abierta y va a trompicones.",
    "",
    "Aparte están los **`watch`**, que reaccionan a que un dato concreto cambie y",
    "reciben el valor nuevo y el viejo:",
    "",
    "```js",
    "watch: {",
