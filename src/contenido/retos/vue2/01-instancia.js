...
export default {
  ...
  apunte: codigo(
    "Un componente de Vue 2 es un objeto con las cosas repartidas por cajones, cada",
    "uno con su nombre:",
    "",
    "```js",
    "const componente = {",
    ...
    "```",
    "",
    "- `data` guarda el estado. Lo que devuelva se pinta con **dobles llaves**.",
    "- `template` es el HTML del componente.",
    "",
    "**`data` tiene que ser una función que devuelve un objeto**, no un objeto suelto.",
    "El motivo es concreto: un componente se puede montar muchas veces, y si `data`",
    "fuera un objeto, todas las copias compartirían el mismo. Cambiarías un dato en",
    "una habitación y se cambiaría en todas.",
    "",
    "Siendo función, Vue la llama una vez por cada copia y cada una recibe su propio",
    "objeto recién hecho.",
  ),
  inicial: codigo(
    "const componente = {",
