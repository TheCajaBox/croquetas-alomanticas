...
export default {
  ...
  apunte: codigo(
    ...
    "```",
    "",
    "No hace nada en el programa; solo **escribe** lo que le pases para que tú lo",
    "veas. Sirve para mirar por dentro cuando algo no cuadra.",
    "",
    ...
    "```js",
    "const nombre = 'Wayne'",
    "console.log(`Buenas, ${nombre}.`)   // Buenas, Wayne.",
    "```",
    "",
    "Con comillas normales no funciona: `'Buenas, ${nombre}'` sale tal cual, con las",
    "llaves y todo. Tienen que ser las invertidas.",
    "",
    "Dentro de `${...}` puede ir cualquier cuenta, no solo un nombre:",
    "",
    "```js",
