...
export default {
  ...
  apunte: codigo(
    "**Desestructurar** es sacar valores de un objeto o de un array dándoles nombre",
    "en el mismo momento:",
    "",
    "```js",
    ...
    "",
    "```js",
    "const { precio = 0 } = {}               // valor por defecto si no viene",
    "const { senas: { sombrero } } = cartel  // anidado",
    "const { nombre, ...resto } = cartel     // resto: todo lo demás",
    "```",
    "",
    "Y se puede hacer **en el paréntesis de la función**, que es lo más cómodo:",
    "",
    "```js",
    ...
    "```",
    "",
    "Ojo con lo anidado: si `senas` puede no venir, dale también su valor por",
    "defecto (`senas: { sombrero } = {}`) o reventará al intentar abrir un `undefined`.",
  ),
  inicial: codigo(
